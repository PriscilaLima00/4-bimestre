...
public class EfeitoDigitador : MonoBehaviour
{
    ...
    public float tempoEntrLetras = 0.08f;
    ...
    {
        ImprimindoMensagem(mensagemOriginal);
    }
    ...
    public void ImprimindoMensagem(string mensagem)
    {
    ...
    IEnumerator LetraPorLetra(string mensagem)
    {
        ...
        foreach (var letra in mensagem)
        {
            ...
            _audioSource.Play();
            yield return  new WaitForSeconds(tempoEntrLetras);
        }
